...
public:
	...
	enum class  messages {
		...
		ERROR_PCB334_COMMUNICATION_ERROR,
		ERROR_PCB335_COMMUNICATION_ERROR,
		ERROR_PCB336_COMMUNICATION_ERROR,
		...
		ERROR_BIOPSY_X_POSITIONING,
		ERROR_BIOPSY_Y_POSITIONING,
		ERROR_BIOPSY_Z_POSITIONING,
